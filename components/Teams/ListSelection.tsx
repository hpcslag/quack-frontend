...
const ActivitiesListSelection = ({ teams }) => {
            ...
            <div className="flex px-4 items-center bg-white shadow-lg ml-16 h-24 rounded-custom">
              <div className="flex flex-col justify-center items-center border-r-2 border-gray-200 px-4">
                <button
                  ...
                  type="button"
                  onClick={() =>
                    (location.href = `http://localhost:3000/dashboard/conference/${conference_id}/teams/${team.id}/staffs`)
                  }
                >
                  志工資料
                </button>
              ...
              <div className="flex  flex-grow justify-end">
                <button
                  ...
                  type="button"
                  onClick={() =>
                    (location.href = `./${conference_id}/teams/${team.id}/interviews`)
                  }
                >
                  面試管理
                </button>
                <button
                  ...
                  type="button"
                  onClick={() =>
                    (location.href = `./${conference_id}/teams/${team.id}/imports/import`)
                  }
                >
                  匯入
                </button>
